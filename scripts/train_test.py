...
import random
from losses import BCELoss_balanced, FocalLoss_balanced
...
loss_com_balanced = BCELoss_balanced(reduction='none')
loss_com_focal_balanced = FocalLoss_balanced()
