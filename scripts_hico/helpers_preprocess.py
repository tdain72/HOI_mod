...
def get_compact_label(segment_key, flag):
    ...
    labels_np = np.zeros([no_person_dets, no_object_dets, NO_VERBS],
                         np.int32)
    labels_object = np.zeros([no_person_dets, no_object_dets],
                         np.int32)
            ...
            if a_o_boxes and d_o_boxes:
                for do in range(len(d_o_boxes)):
                    ...
                    # enough iou
                        ...
                        labels_object[dd, do] = OBJ2ID_HICO[current_hoi['obj_str']]
                        labels_np[dd, do, verb_idx] = 1

        labels_object = labels_object.reshape(no_person_dets * no_object_dets)
